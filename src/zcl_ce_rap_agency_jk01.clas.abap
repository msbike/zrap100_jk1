CLASS zcl_ce_rap_agency_JK01 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES t_agency_range TYPE RANGE OF zz_travel_agency_es5_jk01-agencyid.
    TYPES t_business_data TYPE TABLE OF zz_travel_agency_es5_jk01.
...
CLASS zcl_ce_rap_agency_JK01 IMPLEMENTATION.
  ...
  METHOD get_agencies.
    ...
    service_consumption_name = to_upper( 'ZSC_RAP_AGENCY_JK01' ).
