CLASS zcl_rap100_gen_data_jk1 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_jk1 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA:
      group_id   TYPE string VALUE 'jk1',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atravjk1.
*    DELETE FROM zrap100_dtravjk1.

    "insert travel demo data
    INSERT zrap100_atravjk1  FROM (
        SELECT
